        ...
        <div className='flex flex-col w-full max-w-[700px] '>
          ...
          <motion.form 
            ...
            <div className='flex gap-x-6 w-full '>
              <input type="text" placeholder='name' className='input border-white' />
              <input type="text" placeholder='email' className='input border-white' />
            </div>
            <input type="text" placeholder='subject' className='input border-white' />
            <textarea placeholder='message' className='textarea border-white'></textarea> 
